from distributedSpider.DistributedSpider import *
...
server.start_server(QtNetwork.QHostAddress("127.0.0.1"), 1234, "http://bbs.tianya.cn/list-develop-1.shtml", 2, 2, False)
app.exec()
